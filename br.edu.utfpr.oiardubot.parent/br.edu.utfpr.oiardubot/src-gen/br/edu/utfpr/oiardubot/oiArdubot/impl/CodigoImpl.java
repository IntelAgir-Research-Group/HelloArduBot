 ...
 * </p>
 * <ul>
 *   <li>{@link br.edu.utfpr.oiardubot.oiArdubot.impl.CodigoImpl#getCode <em>Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CodigoImpl extends MinimalEObjectImpl.Container implements Codigo
{
  ...
  public EList<Implementacao> getCode()
  {
    if (code == null)
    {
      code = new EObjectContainmentEList<Implementacao>(Implementacao.class, this, OiArdubotPackage.CODIGO__CODE);
    }
    return code;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OiArdubotPackage.CODIGO__CODE:
